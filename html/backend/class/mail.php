    ...
    public function sendMailSellerRemind(){
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()) {
                ...
                $body = $name . " 先生/小姐您好，提醒您於 9/19(六) 10:00-12:00 將下列要賣的課本帶至博理藝廊：" . "<br>" . "<br>";
                ...
                if ($resultInside->num_rows > 0) {
                    ...
                    $body = $body . "<br><br>" . "註1：我們所收書籍須為目前上課用的版本(請和賣書表單內的課本圖片相同)，若不相同，我們將拒絕收取書籍，請您先確認書籍的版本";
                    
                    $body = $body . "<br><br>" . "註2：明天 9/18(五) 18:00 將直播抽出填賣書表單的 100 元現金和計算機，請關注電機二手書粉專，若您中獎請於隔天交書時領取獎品";
        ...
        */
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()) {
                ...
                $connInside4->close();
                $body = $body . "<br>若無法來領書錢及退書，請於 9/21(一) 12:30 - 13:00 至系K來領取書錢及退書，並且關注"; 
                $body = $body . '<a href="https://www.facebook.com/EESHB/">電機二手書粉絲專頁</a>';
                $body = $body . '的公告';
