...
const Home = () => {
  ...
  return (
    <div id="Home_container">
      ...
      <div
        id="Home_btns"
        className="d-flex mx-auto justify-content-between mt-n4 mt-md-n5 col-11 col-sm-10 col-md-8 col-lg-7 col-xl-6"
      >
        <Link to="/BuyBook">
        ...
        <Link to="/Rules">
          <div className="Home_btns_div col">
            <div id="Home_Rules_div" className="d-flex justify-content-center">
              <button className="Home_btn_anime" id="Home_Rules_btn">
        ...
        <Link to="/SellBook">
          <div className="Home_btns_div col">
            <div
              id="Home_SellBook_div"
              className="d-flex justify-content-center"
            >
              <button className="Home_btn_anime" id="Home_SellBook_btn">
                <img src={sellbook} alt="sellbook"></img>
              </button>
            </div>
            <p>SellBook</p>
          </div>
