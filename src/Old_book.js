...
const Old_book = (props) => {
  ...
  const getOldBookListfromBackend = (newCategory) => {
    ...
    axios
      .post("https://book.ntuee.org/backend/showOldBook.php", {
  ...
  const getAllOldBook = () => {
    axios
      .post("https://book.ntuee.org/backend/allOldBook.php", {})
      .then((data) => {
        if (data.data.success === 1) {
  ...
  useEffect(() => {
    document.documentElement.style.setProperty(
      "--bg-image-pc",
      "var(--bg-image-purple-pc)"
    );
    document.documentElement.style.setProperty(
      "--bg-image-mobile",
      "var(--bg-image-purple-mobile)"
    );
    ...
    <div id="Old_book_container" className="card text-center">
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <button
          ...
          data-target="#Old_book_nav"
          aria-controls="Old_book_nav"
          aria-expanded="false"
        ...
        <div
          id="Old_book_nav"
          className="card-header collapse navbar-collapse bg-light"
      ...
      <Scrollbars renderThumbVertical={renderThumb}>
        <div
          ...
          style={{ backgroundColor: "var(--primary-color-6)" }}
        >
          {categoryCardList}
        </div>
      </Scrollbars>
      ...
      if (props.data[category]) {
        ...
        navtabs_list.push(
          <li className="nav-item dropdown col-12 col-sm-6 col-md-4 col-lg-3 col-xl p-xl-0">
            ...
            <div className="dropdown-menu">{dropdown_items}</div>
          </li>
        );
      } else {
        navtabs_list.push(
  ...
  return (
    <div className="card mx-1 my-3 mx-md-2 m-lg-3 Old_book_card">
      <div className="mx-1 my-3 mx-md-2 m-lg-3">
        <img
          src={image_path + props.data.picture + ".jpg"}
          className="card-img-top img-fluid Old_book_card_img"
